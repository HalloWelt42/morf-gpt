...
DEFINITIONEN: tuple[Definition, ...] = (
    # --- Quelle und Auswahl -------------------------------------------------
    Definition(
        "quelle.mindest_dauer_s",
        "Mindestdauer eines Videos",
    ...
    Definition(
        "quelle.nur_heruntergeladene",
        "Nur bereits heruntergeladene Videos",
    ...
    Definition(
        "quelle.serien_kennung",
        "Kennung der Erklärserie",
    ...
    Definition(
        "band.parallel.stueckelung",
        "Parallele Stückelungen",
    ...
    Definition(
        "band.herzschlag_frist_s",
        "Frist ohne Lebenszeichen",
    ...
    Definition(
        "band.pause.transkription", "Stufe Transkription pausiert", "Keine neuen Transkriptionen starten.", "schalter", False, "band"
    ),
    ...
    Definition(
        ...
        "Adresse des Whisper-Workers",
        "HTTP-Adresse des txt2voice-Workers.",
        "text",
        "http://127.0.0.1:10033",
        "transkription",
    ),
    Definition(
        "transkription.app_url",
        "Adresse der txt2voice-App",
        "HTTP-Adresse des txt2voice-Backends.",
        "text",
        "http://127.0.0.1:10031",
        "transkription",
    ),
    Definition(
        "transkription.sprache",
        "Sprache",
        "Sprache der Aufnahmen (Whisper-Sprachname).",
        "text",
        "german",
        "transkription",
    ),
    Definition(
        "transkription.zeitgrenze_s",
        "Zeitgrenze je Transkription",
    ...
    Definition(
        "transkription.wortzeiten_speichern",
        "Wortzeiten speichern",
    ...
    # --- Korrektur -------------------------------------------------------------
    Definition(
        "korrektur.block_zeichen",
        "Blockgröße der Korrektur",
    ...
    Definition(
        "korrektur.mindest_aehnlichkeit",
        "Abweichungswächter",
    ...
    Definition(
        "korrektur.zeitgrenze_s",
        "Zeitgrenze je Modellaufruf",
    ...
    Definition(
        "korrektur.themen",
        "Themenaufschlüsselung erstellen",
    ...
    # --- Stückelung ------------------------------------------------------------
    Definition(
        "stueckelung.ziel_zeichen",
        "Zielgröße eines Stücks",
    ...
    Definition(
        "stueckelung.ueberlappung_zeichen",
        "Überlappung",
    ...
    Definition(
        "einbettung.anfragen_je_instanz",
        "Gleichzeitige Anfragen je Instanz",
        "So viele Stapel gehen gleichzeitig an jede Instanz. Gemessen bringen 2 bis 4 etwa 20 Prozent, mehr nichts.",
        "ganzzahl",
        2,
        "einbettung",
        minimum=1,
    ...
    Definition(
        "einbettung.speicher_reserve_gb",
        "Speicherreserve beim Laden",
        "So viel Speicher muss nach dem Laden einer weiteren Instanz frei bleiben (frei plus inaktiv).",
        "ganzzahl",
        8,
        "einbettung",
        einheit="GB",
    ...
    Definition(
        "einbettung.lms_pfad",
        "Pfad zur LM-Studio-Befehlszeile",
        "Programm lms, mit dem weitere Instanzen geladen werden; leer heißt: im Pfad oder unter ~/.lmstudio/bin/lms suchen.",
        "text",
        "",
        "einbettung",
    ),
    Definition(
        "einbettung.zeitgrenze_s",
        "Zeitgrenze je Aufruf",
        "So lange darf ein Einbettungsaufruf dauern.",
        "ganzzahl",
        600,
        "einbettung",
        einheit="Sekunden",
    ...
    Definition(
        "suche.kandidaten_faktor",
        "Kandidaten je Treffer",
    ...
    Definition(
        "chat.zeitgrenze_s",
        "Zeitgrenze je Antwort",
        "So lange darf eine Antwort dauern.",
        "ganzzahl",
        1800,
        "chat",
        einheit="Sekunden",
    ...
    Definition(
        "anbieter.korrektur", "Anbieter für Korrektur", "Kennung des Sprachmodell-Anbieters für die Korrektur.", "text", "", "anbieter"
    ),
    Definition(
        "anbieter.einbettung",
        "Anbieter für Einbettung",
        "Kennung des Einbettungsanbieters (baut und befragt den Index).",
        "text",
        "",
        "anbieter",
    ),
